...
public class PhoenixConsumer {
    ...
    public PhoenixConsumer(String path) {
        // intialize the kafka
        intializeKafka(path);
     ...
     * @param path
     */
    public void intializeKafka(String path) {
        Preconditions.checkNotNull(path,"File path cannot be empty, please specify in the arguments");
